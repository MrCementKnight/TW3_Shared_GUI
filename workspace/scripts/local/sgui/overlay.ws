...
exec function sgui_ov( optional second : bool ) : void
{
	...
	var SGUI_overlayPopupRef  : SGUI_CR4OverlayPopup;
	var messageText : string = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
	var duration : float = 4000;
	var queue : bool;
	...
	//SGUI_notificationData.duration = duration;
	//SGUI_notificationData.queue = queue;
